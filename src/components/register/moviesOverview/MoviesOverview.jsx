...
function MoviesOverview() {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full max-w-5xl m-auto p-5 border rounded bg-gray-900">
      {movie && (
        <>
          ...
          <div className="mt-10 md:mt-0 md:ml-10 w-full md:w-1/2 lg:w-2/3 text-center">
            ...
            <div className="flex flex-col md:flex-row justify-between">
              <p className="text-md font-semibold mb-2 md:mb-0">Release Date: <span className="text-gray-400 ml-2">{movie.release_date}</span></p>
              <p className="flex items-center text-md font-semibold">Rating: <span className="flex text-gray-400 ml-2">{renderStars(movie.vote_average)}</span></p>
            </div>
            <div className="mt-5">
